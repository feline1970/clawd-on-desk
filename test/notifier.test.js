...
describe("pushover notifier", () => {
  ...
  it("sends success notification for display attention state", async () => {
    const calls = [];
    const notifier = createPushoverNotifier({
      env: {
        PUSHOVER_ENABLED: "true",
...
describe("telegram notifier", () => {
  ...
  it("sends success notification for cursor Stop with non-attention state", async () => {
    const calls = [];
    const notifier = createPushoverNotifier({
      env: {
        PUSHOVER_ENABLED: "true",
